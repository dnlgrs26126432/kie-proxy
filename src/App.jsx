...
<div style={{fontSize:12,color:MU,marginBottom:10,lineHeight:1.5}}>{apiKey?`✓ kie.ai pronta · ${genre}, ${mood}, ${bpm} BPM`:"Clicca '🔑 API Key' in alto e incolla la tua key kie.ai per generare audio direttamente qui."}</div>
