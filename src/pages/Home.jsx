...
{projects.map(p=>(
<div key={p.id} onClick={()=>navigate(`/studio/${p.id}`)} style={{background:CD,border:`1px solid ${BR}`,borderRadius:12,padding:16,cursor:"pointer",transition:"border-color 0.15s"}}
onMouseEnter={e=>e.currentTarget.style.borderColor=V} onMouseLeave={e=>e.currentTarget.style.borderColor=BR}>
